<template>
    <div class="sidebar">
        ...
        <div class="menu-items">
            ...
            <router-link to="/managebills" active-class="active" tag="button" exact class="side-btn">
                <div class="link-container">
                    Manage Bills
                </div>
            </router-link>
            <router-link to="/billingevents" active-class="active" tag="button" exact class="side-btn">
                <div class="link-container">
                    Billing events 
                    & Calendar
                </div>
